...
CREATE TABLE IF NOT EXISTS message_logs (
  ...
  status TEXT NOT NULL DEFAULT 'pending' CHECK (status IN ('pending', 'processing', 'sent', 'failed', 'delivered', 'read', 'skipped')),
  error_message TEXT,
...
CREATE INDEX IF NOT EXISTS idx_feed_items_normalized_url ON feed_items(feed_id, normalized_url);
CREATE INDEX IF NOT EXISTS idx_feed_items_content_hash ON feed_items(feed_id, content_hash);
...
CREATE INDEX IF NOT EXISTS idx_message_logs_processing_started_at ON message_logs(processing_started_at);
